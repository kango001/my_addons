...
def run():
    ...
    try:
        ...
        if item.action == "getmainlist":
            ...
            file_keyboard = xbmc.translatePath("special://profile/keymaps/sport365.live.xml")
            if config.get_setting("matchcenter_enabled") == "true" and not os.path.exists(file_keyboard):
                ...
                data = '<keymap><global><keyboard><key id="%s">'  % tecla + 'runplugin(plugin://plugin.video.sport365.live/?ewogICAgImFjdGlvbiI6ICJzdGFydCIsIAogICAgImNoYW5uZWwiOiAibWF0Y2hjZW50ZXIiLCAKICAgICJpbmZvTGFiZWxzIjoge30KfQ%3D%3D))</key></keyboard></global></keymap>'
            ...
            if item.action == "play":
                ...
                if hasattr(channel, 'play'):
                    ...
                    # If not, shows user an error message
                        ...
                        platformtools.dialog_ok("plugin", "No links found")
