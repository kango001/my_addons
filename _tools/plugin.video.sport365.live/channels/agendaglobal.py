...
def mainlist(item):
    ...
    itemlist.append(Item(channel=__channel__, title="[COLOR yellowgreen]ALL START TIMES ARE +1 HR GMT (eg: 16:00 is 15:00 in uk)[/COLOR]", action="marcador", url="http://www.transfermarkt.es/ticker/index/live", deporte="futbol", thumbnail="http://i.imgur.com/7ouQsE9.png", fanart=fanart))
    itemlist.append(Item(channel=__channel__, title="[COLOR teal]Full Football Schedule[/COLOR]", action="agenda", deporte="futbol", thumbnail="http://i.imgur.com/tvbCnV6.png", fanart=fanart))
    itemlist.append(Item(channel=__channel__, title="[COLOR green]      Matches now live[/COLOR]", action="agenda", deporte="futbol", thumbnail="https://s6.postimg.org/j05ufdno1/agendalive.png", fanart=fanart))
    itemlist.append(Item(channel=__channel__, title="[COLOR green]      Todays live matches[/COLOR]", action="agenda", deporte="futbol", thumbnail="https://s6.postimg.org/mgbqu5p1t/agendamatchoy.png",fanart=fanart))
    itemlist.append(Item(channel=__channel__, title="[COLOR green]      Tomorrows matches[/COLOR]", action="agenda", deporte="futbol", thumbnail="https://s6.postimg.org/lorgdxedt/agendanext.png",fanart=fanart))
    itemlist.append(Item(channel=__channel__, title="[COLOR green]      Search by team[/COLOR]", action="filtro", filtro="equipo", deporte="futbol", thumbnail="https://s6.postimg.org/8m5h5ijv5/agendaequipo.png", fanart=fanart))
    itemlist.append(Item(channel=__channel__, title="[COLOR teal]Othet Sports Schedule[/COLOR]", action="agenda", thumbnail="http://i.imgur.com/T82CZ6S.png",fanart=fanart))
    itemlist.append(Item(channel=__channel__, title="[COLOR green]      Live events[/COLOR]", action="agenda", thumbnail="https://s6.postimg.org/890au3xg1/agendadeporteslive.png",fanart=fanart))
    itemlist.append(Item(channel=__channel__, title="[COLOR green]      Today's Events[/COLOR]", action="agenda", thumbnail="https://s6.postimg.org/ljjk9vymp/agendadeportestoday.png",fanart=fanart))
    itemlist.append(Item(channel=__channel__, title="[COLOR green]      Tomorrow's Events[/COLOR]", action="agenda", thumbnail="https://s6.postimg.org/hr4n7w8i9/agendadeportestomorrow.png",fanart=fanart))
    itemlist.append(Item(channel=__channel__, title="[COLOR green]      Search by Sport Event[/COLOR]", action="filtro", filtro="deporte", thumbnail="https://s6.postimg.org/meap9nvv5/agendadeportesfiltrar.png",fanart=fanart))
